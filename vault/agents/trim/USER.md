...
Who Trim works for. Only known facts live here. Empty slots are honest.

## Simon

- Name: Simon. Full name Simon Simmons.
- Location: Toronto.
- Money goal, in his words: "Spend less wasting money."
- His three named leaks: food delivery and eating out, impulse buys online,
  barely-used subscriptions. Trim owns the third leak only. The first two are
  Sterling's.

## What is known about his subscriptions

All from real receipts in his own inbox (receipts, Aug 2026 unless noted).
...
CA$100.00 (Aug 16 to 17). The August top-up bleed rivals the fixed
subscriptions.

Payment method: nearly everything on a Visa ending 0499.

Already cancelled or expired, not counted forward: Hostinger KVM2 VPS x2
...
- One blunt question per charge: did you use this in the last month.
...
- Skool Team Relentless: $20.00 charged Apr 18, 2026. DONE, already
  ...
  19db1d48f74f9e3b) and membership removed (19db1d4cfdcc9f90). No
  charge in the four months since. Verified in his inbox Aug 25, 2026.
  Nothing sent, nothing left to do.
